...
v3: now cover&coral has the fish and fish grazing models, this only has coral models and effect sizes
...
#### Initial Models ####
m1 <- glmmTMB(All.Corals ~ Treatment + (1|Site) + (1|Tile), zi = ~ 0, data = corals.2021_wide, family = poisson)
